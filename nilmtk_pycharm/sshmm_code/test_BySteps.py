...
(test_id, modeldb, dataset, precision, measure, denoised, algo_name) = ['sVa_BigO_L01', 'BigO_L02', 'AMPdsR1_1min_A', 10, 'A', 'noisy', 'Viterbi'] 
...
#%%
print()
folds_tot = Folding(dataset_loader(datasets_dir % dataset, labels, precision, denoised), folds)
