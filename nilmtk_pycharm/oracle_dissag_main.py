...
test_dset = df_new.truncate(before = "2014-08-17 00:00:00", after = "2014-08-17 23:59:59")
...
result = localize_anomalous_appliance(test_dset[sel_appliances],train_result,appliance_count=1,take_context=True)# appliance anomaly detect
